...
double compute_access_time() {
    ...
    */
	double timeForFaults = DISK_IO_TIME * pagefaults_count;
	double timeForHits = TLB_ACCESS_TIME * tlbhits_count;
	double timeForMisses = 2 * MEM_ACCESS_TIME * (reads_count + writes_count - tlbhits_count);	
